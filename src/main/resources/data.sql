...
BEGIN
    ...
    if not found then
        ...
        INSERT INTO REKS (REK_ID, TO_USER_ID, FROM_USER_ID, DESCRIPTION, CATEGORY_ID, WAGER, URL, CREATED_ON, TITLE, IMAGE_URL) VALUES (uuid_generate_v4(), gcurious_user_id, gcpetri_user_id, ''This show bro...'', tv_category_id, 80, ''https://www.warnerbros.com/movies/lord-rings-fellowship-ring'', LOCALTIMESTAMP, ''LOTR'', ''https://m.media-amazon.com/images/M/MV5BN2EyZjM3NzUtNWUzMi00MTgxLWI0NTctMzY4M2VlOTdjZWRiXkEyXkFqcGdeQXVyNDUzOTQ5MjY@._V1_.jpg'') RETURNING REK_ID INTO lotr_rek_id;
        ...
        INSERT INTO REKS (REK_ID, TO_USER_ID, FROM_USER_ID, DESCRIPTION, CATEGORY_ID, WAGER, URL, CREATED_ON, ARTIST, TITLE, IMAGE_URL) VALUES (uuid_generate_v4(), gcpetri_user_id, gcurious_user_id, ''Check this song out too!'', music_category_id, 30, ''https://open.spotify.com/track/2DkZisoN9h1dLa8Sn5sx0n?si=203a3183a3554086'', LOCALTIMESTAMP, ''Palace'', ''My favorite song'', ''https://i.scdn.co/image/ab67616d0000b273929dae46c6b93942c7499b7d'') RETURNING REK_ID INTO palace_rek_id;
